...
//  using Acclaim.mp, Acclaim.mod, and Acclaim.ast
//
...
void
ConvertASF2ACTOR_BB(char* asf_filename, char* skeleton_filename, m_real scale)
{
...
int
PmLinearMotion::saveAMC_BB( char* name )
{
...
int
PmLinearMotion::openAMC_BB( char* name, m_real scale, int subsample )
{
	assert( this->getBody() );
