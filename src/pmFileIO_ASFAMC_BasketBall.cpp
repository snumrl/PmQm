...
//----------------------------------------------------------------------//
//
//  For acclaim files that are generated from Kaydara Mocap (Basketball Man)
//
#define	PM_MOTION_NUM_JOINT_IN_ASF_FILE	29
#define PM_MOTION_NUM_DUMMY				 8
#define ASF_SCALE 1.0

enum AsfPart	{
	root,
	spineDummy, spine, spine1, spine2, spine3,
	neckDummy, neck, head, headEndDummy, parented_groupDummy,
	LeftShoulderDummy, LeftShoulder, LeftArm, LeftForeArm, LeftHand,
	RightShoulderDummy, RightShoulder, RightArm, RightForeArm, RightHand,
	LeftUpLegDummy, LeftUpLeg, LeftLeg, LeftFoot,
	RightUpLegDummy, RightUpLeg, RightLeg, RightFoot
};
...
{
	root,
	root, spineDummy, spine, spine1, spine2,
	spine3, neckDummy, neck, head, head,
	spine3, LeftShoulderDummy, LeftShoulder, LeftArm, LeftForeArm, 
	spine3, RightShoulderDummy, RightShoulder, RightArm, RightForeArm, 
	spineDummy, LeftUpLegDummy, LeftUpLeg, LeftLeg,
	spineDummy, RightUpLegDummy, RightUpLeg, RightLeg
};
...
static int	AsfJointSequence[] =
{
	...
	PmHuman::UNDEFINED, PmHuman::NECK, PmHuman::HEAD, PmHuman::UNDEFINED, PmHuman::UNDEFINED,
