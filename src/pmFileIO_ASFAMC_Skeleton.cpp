...
//----------------------------------------------------------------------//
//
//  For acclaim files that are generated from Kaydara Mocap (Skeleton)
//
#define	PM_MOTION_NUM_JOINT_IN_ASF_FILE	41
#define PM_MOTION_NUM_DUMMY				 6
#define ASF_SCALE 1.0

enum AsfPart	{
	root,
	Spine_DummyDummy, Spine_Dummy, Spine, Spine1, Spine2,
	NeckDummy, Neck, Head,
	LeftShoulder_DummyDummy, LeftShoulder_Dummy, LeftShoulder,
	LeftArm_Dummy, LeftArm, LeftArmRoll, LeftForeArm, LeftForeArmRoll, LeftHand,
	RightShoulder_DummyDummy, RightShoulder_Dummy, RightShoulder,
	RightArm_Dummy, RightArm, RightArmRoll, RightForeArm, RightForeArmRoll, RightHand,
	LeftHips_DummyDummy, LeftHips_Dummy, LeftUpLeg, LeftUpLegRoll, LeftLeg, LeftLegRoll, LeftFoot,
	RightHips_DummyDummy, RightHips_Dummy, RightUpLeg, RightUpLegRoll, RightLeg, RightLegRoll, RightFoot
};
...
{
	root,
	root, Spine_DummyDummy, Spine_Dummy, Spine, Spine1,
	Spine2, NeckDummy, Neck,
	Spine2, LeftShoulder_DummyDummy, LeftShoulder_Dummy, LeftShoulder,
	LeftArm_Dummy, LeftArm, LeftArmRoll, LeftForeArm, LeftForeArmRoll,
	Spine2, RightShoulder_DummyDummy, RightShoulder_Dummy, RightShoulder,
	RightArm_Dummy, RightArm, RightArmRoll, RightForeArm, RightForeArmRoll,
	root, LeftHips_DummyDummy, LeftHips_Dummy, LeftUpLeg, LeftUpLegRoll, LeftLeg, LeftLegRoll,
	root, RightHips_DummyDummy, RightHips_Dummy, RightUpLeg, RightUpLegRoll, RightLeg, RightLegRoll,
};

static int	AsfJointSequence[] =
{
	PmHuman::PELVIS,
	PmHuman::UNDEFINED, PmHuman::SPINE_1, PmHuman::SPINE_2, PmHuman::SPINE_3, PmHuman::CHEST,
	PmHuman::UNDEFINED, PmHuman::NECK, PmHuman::HEAD, 
	PmHuman::UNDEFINED, PmHuman::LEFT_COLLAR, PmHuman::LEFT_SHOULDER,
	PmHuman::UPPER_LEFT_ARM,  PmHuman::LOWER_LEFT_ARM,  PmHuman::LEFT_PALM, 
	PmHuman::UNDEFINED, PmHuman::RIGHT_SHOULDER, PmHuman::UPPER_RIGHT_ARM, PmHuman::LOWER_RIGHT_ARM, PmHuman::RIGHT_PALM, 
	PmHuman::UNDEFINED, PmHuman::UPPER_LEFT_LEG,  PmHuman::LOWER_LEFT_LEG,  PmHuman::LEFT_FOOT,  
	PmHuman::UNDEFINED, PmHuman::UPPER_RIGHT_LEG, PmHuman::LOWER_RIGHT_LEG, PmHuman::RIGHT_FOOT 
};
...
void
ConvertASF2ACTOR_BasketBall(char* asf_filename, char* skeleton_filename, m_real scale)
{
...
int
PmLinearMotion::saveAMC_BasketBall( char* name )
{
...
int
PmLinearMotion::openAMC_BasketBall( char* name, m_real scale, int subsample )
{
	assert( this->getBody() );
