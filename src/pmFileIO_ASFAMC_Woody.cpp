...
//----------------------------------------------------------------------//
//
//  For acclaim files that are generated from Kaydara Mocap (Woody)
//
#define	PM_MOTION_NUM_JOINT_IN_ASF_FILE	26
#define PM_MOTION_NUM_DUMMY				 6
#define ASF_SCALE 1.0

enum AsfPart	{
	root,
	RightUpLegDummy, RightUpLeg, RightLeg, RightFoot, RightToes,
	SpineDummy, Spine, Spine1, HEadDummy, HEad,
	LeftShoulder1Dummy, LeftShoulder1, LeftArm, LeftForeArm, LeftHand,
	RightShoulderDummy, RightShoulder, RightArm, RightForeArm, RightHand,
	LeftUpLegDummy, LeftUpLeg, LeftLeg, LeftFoot, LeftToes
};
...
{
	root,
	root, RightUpLegDummy, RightUpLeg, RightLeg, RightFoot,
	root, SpineDummy, Spine, Spine1, HEadDummy,
	Spine1, LeftShoulder1Dummy, LeftShoulder1, LeftArm, LeftForeArm, 
	Spine1, RightShoulderDummy, RightShoulder, RightArm, RightForeArm, 
	root, LeftUpLegDummy, LeftUpLeg, LeftLeg, LeftFoot
};
...
static int	AsfJointSequence[] =
{
	...
	PmHuman::UNDEFINED, PmHuman::SPINE_2, PmHuman::CHEST, PmHuman::UNDEFINED, PmHuman::NECK,
...
void
ConvertASF2ACTOR_Woody(char* asf_filename, char* skeleton_filename, m_real scale)
{
...
int
PmLinearMotion::saveAMC_Woody( char* name )
{
...
int
PmLinearMotion::openAMC_Woody( char* name, m_real scale, int subsample )
{
	assert( this->getBody() );
