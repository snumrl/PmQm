...
//----------------------------------------------------------------------//
//
//  For acclaim files that are generated from Kaydara Mocap (Chaja)
//
#define	PM_MOTION_NUM_JOINT_IN_ASF_FILE	30
...
enum AsfPart	{
	...
	headDummy, head,
	leftUpLegDummy, leftUpLeg, leftLeg, leftFoot, leftToe, leftToe_end,
	rightUpLegDummy, rightUpLeg, rightLeg, rightFoot, rightToe, rightToe_end
...
static int	AsfParent[] =
{
	...
	Spine3, headDummy,
	root, leftUpLegDummy, leftUpLeg, leftLeg, leftFoot, leftToe,
	root, rightUpLegDummy, rightUpLeg, rightLeg, rightFoot, rightToe
};
...
static int	AsfJointSequence[] =
{
	...
	PmHuman::UNDEFINED, PmHuman::NECK,
	PmHuman::UNDEFINED, PmHuman::UPPER_LEFT_LEG,  PmHuman::LOWER_LEFT_LEG,  PmHuman::LEFT_FOOT,  PmHuman::LEFT_TOE, PmHuman::UNDEFINED,
	PmHuman::UNDEFINED, PmHuman::UPPER_RIGHT_LEG,  PmHuman::LOWER_RIGHT_LEG,  PmHuman::RIGHT_FOOT,  PmHuman::RIGHT_TOE, PmHuman::UNDEFINED
};
...
void
ConvertASF2ACTOR_Chaja(char* asf_filename, char* skeleton_filename, m_real scale)
{
...
int
PmLinearMotion::saveAMC_Chaja( char* name )
{
...
int
PmLinearMotion::openAMC_Chaja( char* name, m_real scale, int subsample )
{
	assert( this->getBody() );
